...
/// the ``Observation/Observable()`` macro to indicate Observation of a type.
//@available(SwiftStdlib 5.9, *)
public struct TrailingEdgeObservationRegistrar: Sendable {
  ...
  private struct State: @unchecked Sendable {
    ...
    internal mutating func didSet<Subject: TrailingEdgeObservable, Member>(keyPath: KeyPath<Subject, Member>) -> ([@Sendable (Any) -> Void], [@Sendable () -> Void]) {
  ...
  internal struct Context: Sendable {
    ...
    internal func willSet<Subject: TrailingEdgeObservable, Member>(
       _ subject: Subject,
    ...
    internal func didSet<Subject: TrailingEdgeObservable, Member>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>
    ) {
  ...
  public func access<Subject: TrailingEdgeObservable, Member>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>
  ) {
  ...
  ///     - subject: An instance of an observable type.
  ///     - keyPath: The key path of an observed property.
  public func willSet<Subject: TrailingEdgeObservable, Member>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>
  ) {
  ...
  ///   - subject: An instance of an observable type.
  ///   - keyPath: The key path of an observed property.
  public func didSet<Subject: TrailingEdgeObservable, Member>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>
  ) {
  ...
  ///   - keyPath: The key path of an observed property.
  public func withMutation<Subject: TrailingEdgeObservable, Member, T>(
    of subject: Subject,
    keyPath: KeyPath<Subject, Member>,
    _ mutation: () throws -> T
  ) rethrows -> T {
...
//@available(SwiftStdlib 5.9, *)
extension TrailingEdgeObservationRegistrar: Codable {
...
//@available(SwiftStdlib 5.9, *)
extension TrailingEdgeObservationRegistrar: Hashable {
